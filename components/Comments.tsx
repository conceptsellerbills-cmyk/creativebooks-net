...
export function Comments({ title }: CommentsProps) {
  ...
  useEffect(() => {
    ...
    script.setAttribute("data-repo", "conceptsellerbills-cmyk/creativebooks-net");
    script.setAttribute("data-repo-id", "R_kgDOR8_5VA");
    script.setAttribute("data-category", "General");
    script.setAttribute("data-category-id", "DIC_kwDOR8_5VM4C6ga6");
