...
export const metadata: Metadata = { title: "Contact — Creative Books", description: "Get in touch with the Creative Books team." };
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="info-card">
          ...
          <p>For faster responses, email us at <a href="mailto:hello@creativebooks.net">hello@creativebooks.net</a>. We reply within 1–2 business days.</p>
        </div>
