...
export const metadata: Metadata = { title: "Write for Us — Creative Books", description: "Contribute a guest post to Creative Books. Share your expertise on books and creative writing." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p className="page-subtitle">We welcome guest contributors who can bring original insights and expertise to our readers. If you know books and creative writing well, we'd love to publish your work.</p>
        <hr className="page-divider" />
        <h2>What We're Looking For</h2>
        <ul>
          <li>Original, well-researched articles on books and creative writing</li>
        ...
        <h2>How to Pitch</h2>
        <p>Email us at <a href="mailto:hello@creativebooks.net">hello@creativebooks.net</a> with the subject line "Guest Post Pitch" and include:</p>
        <ul>
