...
export const metadata: Metadata = { title: "Advertise — Creative Books", description: "Advertise with Creative Books and reach a targeted audience interested in books and creative writing." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on Creative Books</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing books and creative writing. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@creativebooks.net">hello@creativebooks.net</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
