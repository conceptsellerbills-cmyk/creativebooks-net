...
const BASE = 'https://www.creativebooks.net'

const CATEGORIES: string[] = ["writing-craft","design","photography","creativity","fiction","marketing","psychology","biography","art","copywriting","screenwriting","architecture","music","poetry","business"]
