...
const CATEGORIES: { label: string; href: string }[] = [{"label":"✍️ Writing Craft","href":"/category/writing-craft"},{"label":"🎨 Design Books","href":"/category/design"},{"label":"📷 Photography","href":"/category/photography"},{"label":"🧠 Creativity","href":"/category/creativity"},{"label":"📖 Inspiring Fiction","href":"/category/fiction"},{"label":"🚀 Brand & Marketing","href":"/category/marketing"},{"label":"🧬 Psychology","href":"/category/psychology"},{"label":"👤 Biographies","href":"/category/biography"},{"label":"🖼️ Art Books","href":"/category/art"},{"label":"✒️ Copywriting","href":"/category/copywriting"},{"label":"🎬 Screenwriting","href":"/category/screenwriting"},{"label":"🏛️ Architecture","href":"/category/architecture"},{"label":"🎵 Music & Songwriting","href":"/category/music"},{"label":"📜 Poetry","href":"/category/poetry"},{"label":"💼 Business Books","href":"/category/business"}];
...
export default async function ArticlePage({ params }: Props) {
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.creativebooks.net" },
      ...(post.category ? [{ "@type": "ListItem", position: 2, name: post.category.replace(/-/g, " ").replace(/\b\w/g, (l: string) => l.toUpperCase()), item: `https://www.creativebooks.net/category/${post.category}` }] : []),
      { "@type": "ListItem", position: post.category ? 3 : 2, name: post.title, item: `https://www.creativebooks.net/${slug}` },
    ],
  });
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        :root{--bg:#0d0d0d;--surface:#111520;--border:#1e2535;--text:#e4e8f4;--muted:#7a82a0;--accent:#f97316;--radius:10px}
          ...
          <article className="article">
            ...
            <div className="author-box">
              ...
              <div className="author-info">
                <div className="author-name">Creative Books Editorial Team</div>
