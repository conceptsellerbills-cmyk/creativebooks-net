...
export const metadata: Metadata = { title: "Cookie Policy — Creative Books", description: "Cookie Policy for Creative Books (creativebooks.net)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h2>Contact</h2>
        <p>If you have questions about our cookie use, contact us at <a href="mailto:hello@creativebooks.net">hello@creativebooks.net</a>.</p>
      </div>
    </>
  );
}
