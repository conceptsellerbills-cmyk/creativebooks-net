    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-bg { position: absolute; inset: 0; background: radial-gradient(ellipse 80% 60% at 50% -10%, rgba(245,158,11,0.18) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(239,68,68,0.1) 0%, transparent 60%); pointer-events: none; }
      ...
      <section className="hero">
        ...
        <div className="hero-badge">For Writers, Designers & Artists</div>
        <h1 dangerouslySetInnerHTML={{ __html: "Books That Ignite<br />Your Creative Fire" }} />
        <p>Curated reviews and reading lists for writers, designers, photographers and artists. Find the book that unlocks your next creative breakthrough.</p>
        <div className="hero-ctas">
          <a href="/reading-lists" className="hero-cta-primary">Explore Reading Lists →</a>
          <a href="/categories" className="hero-cta-secondary">Browse Categories →</a>
        </div>
        <div className="stats-bar">
          {([{"v":"1000+","l":"Books Reviewed"},{"v":"30+","l":"Genres"},{"v":"Monthly","l":"New Picks"},{"v":"2025","l":"Current"}] as {v:string,l:string}[]).map((st) => (
      ...
      <div className="container">
        ...
        <section className="section" style={{ paddingBottom: 40 }}>
          ...
          <div className="trending-row">
            {([{"label":"Books for Writers","hot":true,"href":"/best-books-for-writers"},{"label":"Design Thinking","href":"/design-thinking-books"},{"label":"Creative Block","hot":true,"href":"/overcome-creative-block-books"},{"label":"Photography Books","href":"/best-photography-books"},{"label":"Brand Storytelling","href":"/brand-storytelling-books"},{"label":"Fiction for Creatives","hot":true,"href":"/inspiring-fiction-creatives"}] as {label:string,hot?:boolean,href:string}[]).map((t) => (
        ...
        <section className="section" style={{ paddingTop: 20 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Must-Read Books for Creatives</h2>
          </div>
          <div className="picks-grid">
            {([{"badge":"All-Time Classic","badgeType":"gold","icon":"📖","title":"The War of Art","desc":"Steven Pressfield's essential guide to overcoming resistance and doing your creative work.","rating":5,"href":"/the-war-of-art-review"},{"badge":"For Designers","badgeType":"silver","icon":"🎨","title":"The Elements of Style","desc":"Timeless principles of clear, visual communication every designer should know deeply.","rating":5,"href":"/elements-of-style-review"},{"badge":"For Writers","badgeType":"bronze","icon":"✍️","title":"On Writing — Stephen King","desc":"Part memoir, part masterclass. King's blueprint for the craft of storytelling.","rating":5,"href":"/on-writing-stephen-king-review"}] as {badge:string,badgeType:string,icon:string,title:string,desc:string,rating:number,href:string}[]).map((p, i) => (
        ...
        <section className="section">
          ...
          <div className="section-header">
            <h2 className="section-title">How We Curate Book Lists</h2>
          </div>
          <div className="how-grid">
            {([{"num":"01","title":"We Read Everything","desc":"Our team reads every book cover to cover before writing a single word of review."},{"num":"02","title":"We Extract Value","desc":"We identify the core insights, who the book is for, and what you'll take away from it."},{"num":"03","title":"You Read with Purpose","desc":"Our reviews help you pick exactly the right book for your current creative challenge."}] as {num:string,title:string,desc:string}[]).map((h) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="category-grid">
            {([{"icon":"✍️","label":"Writing Craft","desc":"Storytelling, structure & voice","href":"/category/writing-craft"},{"icon":"🎨","label":"Design Books","desc":"Graphic, UI/UX & visual design","href":"/category/design"},{"icon":"📷","label":"Photography","desc":"Technique, eye & composition","href":"/category/photography"},{"icon":"🧠","label":"Creativity","desc":"Mindset, process & inspiration","href":"/category/creativity"},{"icon":"📖","label":"Inspiring Fiction","desc":"Novels that fuel imagination","href":"/category/fiction"},{"icon":"🚀","label":"Brand & Marketing","desc":"Storytelling for brands","href":"/category/marketing"},{"icon":"🧬","label":"Psychology","desc":"Mind, behavior & mental health","href":"/category/psychology"},{"icon":"👤","label":"Biographies & Memoirs","desc":"Inspiring life stories","href":"/category/biography"},{"icon":"🖼️","label":"Art Books","desc":"Painting, illustration & art history","href":"/category/art"},{"icon":"✒️","label":"Copywriting","desc":"Persuasive writing & ads","href":"/category/copywriting"},{"icon":"🎬","label":"Screenwriting","desc":"Film, TV & script writing","href":"/category/screenwriting"},{"icon":"🏛️","label":"Architecture & Design","desc":"Spaces, buildings & interiors","href":"/category/architecture"},{"icon":"🎵","label":"Music & Songwriting","desc":"Theory, composition & creativity","href":"/category/music"},{"icon":"📜","label":"Poetry","desc":"Collections, craft & verse","href":"/category/poetry"},{"icon":"💼","label":"Business Books","desc":"Leadership, strategy & startups","href":"/category/business"}] as {icon:string,label:string,desc:string,href:string}[]).map((c) => (
          ...
          <section className="section" style={{ paddingTop: 0 }}>
            ...
            <a href={`/${featured.slug}`} className="featured-card">
              ...
              <div className="featured-content">
                <span className="featured-badge">📖 Must Read</span>
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Why Readers Trust CreativeBooks</h2>
          </div>
          <div className="why-grid">
            {([{"icon":"📚","title":"We Actually Read Them","desc":"No AI summaries or publisher blurbs. Every book is read in full by a real creative professional."},{"icon":"🎯","title":"Practical Focus","desc":"We highlight what's actionable, not just what sounds impressive on a reading list."},{"icon":"🌍","title":"All Creative Disciplines","desc":"From novelists to UX designers to photographers — we cover all creative fields."},{"icon":"💬","title":"Community Picks","desc":"Monthly reading lists shaped by input from 10,000+ creative readers worldwide."}] as {icon:string,title:string,desc:string}[]).map((w) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="faq-list">
            {([{"q":"What is the best book for someone just starting to write?","a":"\"On Writing\" by Stephen King and \"Bird by Bird\" by Anne Lamott are both exceptional starting points — honest, practical and deeply inspiring."},{"q":"Are your reading lists suitable for beginners?","a":"Yes — we tag each book with experience level (Beginner / Intermediate / Advanced) so you can find the right entry point."},{"q":"Do you cover books on creativity and mindset?","a":"Absolutely. Books like \"The Artist's Way\" and \"Big Magic\" are central to our creativity category."},{"q":"How often do you add new reviews?","a":"We publish 8-12 new book reviews every month, plus seasonal reading lists curated around creative themes."},{"q":"Can I suggest a book for review?","a":"Yes! We review reader suggestions monthly. Use our contact page to submit your recommendation."}] as {q:string,a:string}[]).map((f) => (
        ...
        <div className="newsletter-section">
          <h2>Monthly Reading List for Creatives</h2>
          <p>Get 5 hand-picked books delivered to your inbox every month — curated for your creative discipline.</p>
          <NewsletterForm />
        </div>

        {/* ── CTA ── */}
        <div className="cta-section">
          <h2>Find Your Next Creative Obsession</h2>
          <p>Hand-picked book reviews that fuel creativity, sharpen skills and spark ideas you can actually use.</p>
          <a href="/reading-lists" className="cta-btn">Browse All Book Reviews →</a>
        </div>
