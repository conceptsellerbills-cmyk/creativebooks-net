      ...
      <div className="container">
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="category-grid">
            {([{"icon":"✍️","label":"Writing Craft","desc":"Storytelling, structure & voice","href":"/category/writing-craft"},{"icon":"🎨","label":"Design Books","desc":"Graphic, UI/UX & visual design","href":"/category/design"},{"icon":"📷","label":"Photography","desc":"Technique, eye & composition","href":"/category/photography"},{"icon":"🧠","label":"Creativity","desc":"Mindset, process & inspiration","href":"/category/creativity"},{"icon":"📖","label":"Inspiring Fiction","desc":"Novels that fuel imagination","href":"/category/fiction"},{"icon":"🚀","label":"Brand & Marketing","desc":"Storytelling for brands","href":"/category/marketing"}] as {icon:string,label:string,desc:string,href:string}[]).map((c) => (
