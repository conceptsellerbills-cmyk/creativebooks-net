      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
          ...
          --accent: #f59e0b; --accent2: #ef4444; --radius: 12px;
        }
        body { background: var(--bg); color: var(--text); font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; line-height: 1.6; }
        a { text-decoration: none; color: inherit; }
        .container { max-width: 1100px; margin: 0 auto; padding: 0 24px; }
        .hero { position: relative; overflow: hidden; padding: 90px 24px 80px; text-align: center; }
        .hero::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse 80% 60% at 50% -10%, rgba(245,158,11,0.15) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(239,68,68,0.08) 0%, transparent 60%); pointer-events: none; }
        ...
        .featured-visual { display: flex; align-items: center; justify-content: center; min-height: 280px; font-size: 5rem; background: linear-gradient(135deg, rgba(245,158,11,0.12), rgba(239,68,68,0.08)); }
        ...
        .post-tag { display: inline-block; padding: 3px 10px; border-radius: 20px; background: rgba(239,68,68,0.1); border: 1px solid rgba(239,68,68,0.2); color: var(--accent2); font-size: 0.7rem; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; margin-bottom: 12px; }
...
`}</style>
      ...
      <section className="hero">
        ...
        <a href="/reading-lists" className="hero-cta">Explore Reading Lists →</a>
        <div className="stats-bar">
          {([{"v":"1000+","l":"Books Reviewed"},{"v":"30+","l":"Genres"},{"v":"Monthly","l":"New Picks"},{"v":"2025","l":"Current"}] as {v:string,l:string}[]).map((s) => (
      ...
      <div className="container">
        ...
        <div className="cta-section">
          <h2>Never Run Out of Inspiration</h2>
          <p>Discover hand-picked books that fuel creativity, sharpen skills and spark ideas you can actually use.</p>
