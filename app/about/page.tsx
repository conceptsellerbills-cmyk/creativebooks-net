...
export const metadata: Metadata = { title: "About — Creative Books", description: "Learn about Creative Books, our mission, and the team behind the site." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">About Creative Books</h1>
        <p className="page-subtitle">We're a team of passionate writers and researchers dedicated to covering books and creative writing — helping our readers make smarter decisions with honest, in-depth content.</p>
        <hr className="page-divider" />
        <h2>Our Mission</h2>
        <p>Creative Books was created with a single goal: to cut through the noise and give readers clear, trustworthy information about books and creative writing. We research, test, and compare so you don't have to.</p>
        <h2>What We Cover</h2>
        <p>We publish in-depth reviews, comparison guides, how-tos, and roundups on books and creative writing. Every article is written with accuracy and reader value in mind — no filler, no fluff.</p>
