...
export const metadata: Metadata = { title: "Privacy Policy — Creative Books", description: "Privacy Policy for Creative Books (creativebooks.net)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p>Welcome to Creative Books ("we", "us", or "our"), accessible at creativebooks.net. This Privacy Policy explains how we collect, use, and protect your information when you visit our website.</p>
        ...
        <h2>6. Your Rights</h2>
        <p>You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:hello@creativebooks.net">hello@creativebooks.net</a>.</p>
        ...
        <h2>9. Contact</h2>
        <p>For privacy-related questions, contact us at <a href="mailto:hello@creativebooks.net">hello@creativebooks.net</a>.</p>
      </div>
    </>
  );
}
